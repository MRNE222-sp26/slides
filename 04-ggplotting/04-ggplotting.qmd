...
[image: Allison Horst](https://allisonhorst.com/data-science-art){fig-alt="cartoon illustrating continuous and discrete variables"}
...
![[image: Allison Horst](https://allisonhorst.com/data-science-art)](img/horst_nominal-ordinal-binary.png){fig-alt="cartoon illustrating nominal, ordinal, and binary variables"}
:::
...
::: {.column width = "30%"}
![[https://lter.github.io/lterdatasampler/](https://lter.github.io/lterdatasampler/)](img/horst-lter-hex.png){fig-alt="lter datasampler hex logo"}
:::
...
#| code-line-numbers: "2"
#| #| fig-alt: "example of a segmented bar plot"
...
#| code-line-numbers: "3"
#| #| fig-alt: "example of a segmented bar plot with percentages"
...
#| fig-alt: "example of a histogram"
...
```{r message = FALSE}
#| fig-alt: "histogram with bimodal distribution"
ggplot(and, aes(x = length_mm)) +
  geom_histogram(binwidth = 10)
```
...
#| code-line-numbers: "2"
#| fig-alt: "histogram with bimodal distribution and  binwidth=1"
...
```{r out.width = "50%", echo=TRUE}
#| code-line-numbers: "2"
#| #| fig-alt: "histogram with bimodal distribution and  binwidth=10"
...
```{r out.width = "50%", echo=TRUE}
#| code-line-numbers: "2"
#| #| fig-alt: "histogram with bimodal distribution and  binwidth=30"
...
#| fig-alt: "histogram with bimodal distribution with clean labels"
```
...
#| code-line-numbers: "2"
#| fig-alt: "histogram with bimodal distribution and fill mapped to a different categorical variable"
...
#| code-line-numbers: "8"
#| fig-alt: "histogram with bimodal distribution and faceted by a different categorical variable"
...
```{r echo=TRUE}
#| code-line-numbers: "2"
#| fig-alt: "example of a density plot"
...
```{r echo=TRUE}
#| code-line-numbers: "2"
#| fig-alt: "example of a density plot with adjust size=0.5"
...
```{r echo=TRUE}
#| code-line-numbers: "2"
#| fig-alt: "example of a density plot with adjust size=1"
...
```{r echo=TRUE}
#| code-line-numbers: "2"
#| fig-alt: "example of a density plot with adjust size=2"
...
#| fig-alt: "cleaned up example of a density plot"
...
#| fig-alt: "density plot with a different curve for each of two categorical variables"
```
...
```{r ref.label = "hist-fill", echo = FALSE, warning = FALSE}
#| fig-alt: "histogram with fill mapped to a categorical variables"
```
:::
:::
...
## Box plot with one numeric variable (we wouldn't normally do this)

For a vertical boxplot, map the numeric variable to the *y-axis*
```{r echo=TRUE}
#| fig-alt: "example of a boxplot with one numeric variable"
...
::: {.column width = "60%"}
```{r echo=TRUE}
#| fig-alt: "example of a boxplot with outliers"
...
#| code-line-numbers: 1
#| fig-alt: "example of a boxplot with one numeric variable and a categorical variable"
...
#| fig-alt: "example of a scatterplot"
...
```{r warning = FALSE, echo=TRUE}
#| fig-alt: "example of a scatterplot with alpha adjusted"
ggplot(and, aes(x = length_mm, y = weight_g)) +
...
#| fig-alt: "example of a violin plot"
...
#| fig-alt: "example of a ridge plot"
library(ggridges)
ggplot(and, aes(x = length_mm, 
                y = reach)) +
...
#| fig-alt: "example of a horizontal bar plot"
...
#| code-line-numbers: "2"
#| fig-alt: "example of a horizontal bar plot with ordered variables"
...
- In Posit Cloud, open any project and set your PAT by typing `gitcreds::gitcreds_set()` into the console. Enter your PAT (no quotes) when prompted
- Clone your ae-03 from our class GitHub organization page: https://github.com/MRNE222-sp26-activities
- Repeat for lab-02 when you're done with ae-03
- Don't forget to **render, stage, commit, and push** your changes to GitHub when you're done with the exercise and lab
