---
title: "Models with multiple numeric predictors"
...
## So far we have covered: Linear models with a numeric response variable and one or more categorical predictor variable test for a difference in the mean value of each level of the categorical variable
...
## So far we have covered: Linear models with a numeric response variable and a numeric predictor variable test for a linear relationship between the two variables.
...
## So far we have covered: Linear models with a numeric response variable, numeric predictor variable, and a categorical predictor variable fit a different line for each level of the categorical predictor variable
...
# There's one more model formulation we haven't covered yet: two or more numeric predictors
...
## Interpreting regression output with multiple numeric predictors
